...
class NetworkScanner(ReportMixin):
    def __init__(
        ...
        # HTTP(S)-only proxy (existing --proxy flag). Distinct from socks_proxy_url below,
        # which routes ALL scan traffic (raw TCP connect scanning + service fingerprinting).
